...
Three known gaps were deliberately decided against fixing, rather than left as forgotten open work. Both are recorded here so the project doesn't overstate what it guarantees.
